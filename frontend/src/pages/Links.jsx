...
const LINKS = [
  {
    ...
    name: "LinkedIn",
    handle: "@dinkarsable",
    href: "https://linkedin.com/in/dinkarsable",
    Icon: Linkedin,
  },
  {
    key: "x",
...
export default function Links() {
  ...
  return (
    ...
    >
      {/* Sidebar */}
      <aside className="absolute top-0 left-0 pl-8 sm:pl-12 md:pl-16 pt-8 sm:pt-10 md:pt-12 z-10">
        <h2
